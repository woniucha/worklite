...
<table width="90%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC">
  <tr>
    <td height="25" bgcolor="#999999"><div align="center" class="STYLE2 STYLE5">令牌序列号</div></td>
    <td bgcolor="#999999"><div align="center" class="STYLE6">UASS账户</div></td>
    <td bgcolor="#999999"><div align="center" class="STYLE6">所有人</div></td>
    <td bgcolor="#999999"><div align="center" class="STYLE6">所属处室</div></td>
    <td bgcolor="#999999"><div align="center" class="STYLE6">状态</div></td>
    <td bgcolor="#999999"><div align="center" class="STYLE6">动作</div></td>
    <td bgcolor="#999999"><div align="center" class="STYLE6">动作</div></td>
    <td bgcolor="#999999"><div align="center" class="STYLE6">动作</div></td>
    <td bgcolor="#999999"><div align="center" class="STYLE6">动作</div></td>
    <td bgcolor="#999999"><div align="center" class="STYLE6">动作</div></td>
  ...
  <tr>
    ...
    <td bgcolor="#FFFFFF"><div align="center"><span class="STYLE1"><a href="token!annulToken?worklitetoken.token_id=<s:property value="#worklitetoken.token_id"/>">注销</a></span></div></td>
	   ...
	   <tr>
    <td height="25" colspan="10" bgcolor="#FFFFFF"><div align="right">第<s:property value="pageModelByIndication.pageNo"/>页/共<s:property value="pageModelByIndication.totalPages"/>页 <s:property value="pageModelByIndication.totalRecords"/>条记录
	...
	pageModelByIndication.worklitetoken.token_status"/>&worklitetoken.token_loaction=<s:property value="
	pageModelByIndication.worklitetoken.token_loaction"/>&worklitetoken.token_office=<s:property value="
		pageModelByIndication.worklitetoken.token_office"/>&worklitetoken.token_owner=<s:property value="
	...
	<a href="token!findByCondition?pageNo=<s:property value="pageModelByIndication.nextPageNo"/>&pageSize=10&worklitetoken.token_id=<s:property value="pageModelByIndication.worklitetoken.token_id"/>&worklitetoken.token_uass_name=<s:property value="
	pageModelByIndication.worklitetoken.token_uass_name"/>&worklitetoken.token_status=<s:property value="
	pageModelByIndication.worklitetoken.token_status"/>&worklitetoken.token_loaction=<s:property value="
	pageModelByIndication.worklitetoken.token_loaction"/>&worklitetoken.token_office=<s:property value="
	pageModelByIndication.worklitetoken.token_office"/>&worklitetoken.token_owner=<s:property value="
