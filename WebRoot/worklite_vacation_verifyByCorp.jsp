...
.STYLE12 {font-family: "微软雅黑"; font-weight: bold; }
-->
</style>
</head>
...
<body>
            ...
            <form name="form1" method="post" action="vacation!verifyVacationByCorp">
              <table width="80%" border="0" align="center" bgcolor="#999999" cellpadding="1" cellspacing="1">
                ...
                <tr>
                  ...
                  <td bgcolor="#FFFFFF"><div align="right" class="STYLE8">职务：</div></td>
                  <td bgcolor="#FFFFFF"><span class="STYLE9">&nbsp;
                  ...
                  <td bgcolor="#FFFFFF" class="STYLE9"">&nbsp;
                      <s:property value="worklitevacation.vacation_project" />
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td colspan="3" bgcolor="#FFFFFF">&nbsp;
                      <label>
                      <input name="worklitevacation.vacation_corpopinion" type="text" size="55">
                    (50字以内)</label></td>
                  <td colspan="2" bgcolor="#FFFFFF">&nbsp;
					  ...
					  <input type="hidden" name="worklitevacation.vacation_bank_verify" value="<s:property value="worklitevacation.vacation_bank_verify"/>" />
					  <input type="hidden" name="worklitevacation.vacation_corporation_verify" value="<s:property value="worklitevacation.vacation_corporation_verify"/>" />
                      &nbsp;        
                      <input type="submit" name="Submit2" value="未通过" onClick="unpassResult()">  
                      <input name="verifyResult" type="hidden" value=""/></td>
                </tr>
                <tr>
                  <td height="40" bgcolor="#FFFFFF"><div align="right" class="STYLE8">行方审核意见：</div></td>
                  <td colspan="3" bgcolor="#FFFFFF">&nbsp;
                      <s:property value="worklitevacation.vacation_bankopinion" /></td>
                  <td bgcolor="#FFFFFF"><div align="right"><span class="STYLE8">行方审核时间：</span></div></td>
                  <td bgcolor="#FFFFFF">&nbsp;
                      <s:property value="worklitevacation.vacation_bankdate" /></td>
                </tr>
              </table>
                        </form>
</body>
