...
<table width="90%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC">
  <tr>
    <td height="25" bgcolor="#999999"><div align="center" class="STYLE2 STYLE5">图书序列号</div></td>
  ...
  <tr>
    ...
    <td bgcolor="#FFFFFF"><div align="center"><span class="STYLE1"><a href="updatetoken!queryTokenDetail?worklitetoken.token_id=<s:property value="#worklitetoken.token_id"/>">维护</a></span></div></td>
