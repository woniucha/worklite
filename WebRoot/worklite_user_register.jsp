...
<table width="100%" cellpadding="0" cellspacing="1" border="0">
  ...
  <tr>
    <td bgcolor="#999999">
	  <center>
    <form id=""register_form" name="form1" method="post" action="user!register">
      <table width="80%" border="0" align="center">
        <tr>
          <td height="51" colspan="3"><div align="center"><font color="#FFFFFF" size="4" face="微软雅黑">注册新用户</font></div></td>
        </tr>
        <tr>
        ...
        <tr>
          <td width="48%" height="30"><div align="right"><font color="#FFFFFF" size="2" face="微软雅黑">用户姓名(中文)：</font></div></td>
          <td width="14%"><input name="workliteuserinfo.user_name" id="chinaname" type="text" "/></td>
          <td width="38%" id="checkName" class="remind"><font color="#ffff00">
            <c:if test="${requestScope.message!=null}">${requestScope.message}</c:if>
          </font></td>
        </tr>
        ...
        <tr>
          <td height="30"><div align="right"><font color="#FFFFFF" size="2" face="微软雅黑">用户密码：</font></div></td>
          <td><input name="workliteuserlogin.user_pwd" id="password1" type="password" onFocus="clearPwd()" onBlur="checkPassword()" /></td>
          <td class="remind STYLE1" id="checkPwd">密码请设为6-15位字母或数字</td>
        </tr>
        <tr>
          <td height="30"><div align="right"><font color="#FFFFFF" size="2" face="微软雅黑">再次输入密码：</font></div></td>
          <td><label>
            <input id="password2" type="password" name="user_p2" onBlur="checkPwd()" onFocus="clearPwdRemind()"/>
          </label></td>
          <td id="pwdRemind" class="remind" >&nbsp;</td>
        </tr>
        <tr>
          <td height="33" colspan="3"><div align="center">
            <input type="button" id="register" name="register" class="register" value="注册" onClick="checkAll()" />
