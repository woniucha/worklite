  ...
  <table width="80%" border="0" align="center">
    ...
    <tr>
      <td><table width="100%" border="0">
        ...
        <tr>
		  ...
		  <%=i%> . <s:property value="#taskenclosure.task_file_name"/></br>  
		  <% i++;%>
		  </s:iterator>		  </td>
        </tr>
      </table></td>
	...
	<s:iterator value="handlerDMs" id="handler">	
        <tr>
          ...
          <td bgcolor="#FFFFFF" class="STYLE12"><s:property value="#handler.worklitetaskhandler.task_handle_date"/></td> 
		  <td bgcolor="#FFFFFF" class="STYLE12">

		  <% int j=1;%>
		  <s:iterator value="#handler.worklitetaskenclosures" id="handlerenclosure">		  
		  &nbsp; <%=j%> . <s:property value="#handlerenclosure.task_file_name"/></br>  
		  <% j++;%>
		  </s:iterator>
		  </td>
          <td bgcolor="#FFFFFF" class="STYLE12"><div align="center"><s:property value="#handler.worklitetaskhandler.task_handle_estimate_score"/></div></td>
          </tr>
		  </s:iterator>	
      </table></td>
    </tr>
